...
export const aboutContent = {
  paragraphs: [
    "I'm a Senior iOS Developer with 8+ years of experience building native applications in Swift and Objective-C, currently leading iOS engineering at TGI in Lahore. I care about clean architecture, performance, and apps that hold up long after launch.",
  ...
  quote:
    "8+ years of shipping native iOS apps, from the first commit to the App Store.",
} as const;
